...
# load the model
sex_model = pickle.load(open('C:\\Users\\AKSHITA RAI\\OneDrive\\Desktop\\ML\\EndSem4 Project\\Real Time Age,Gender and Emotion detetction\\sex-model-final.pkl', 'rb'))
age_model = pickle.load(open('C:\\Users\\AKSHITA RAI\\OneDrive\\Desktop\\ML\\EndSem4 Project\\Real Time Age,Gender and Emotion detetction\\age-model-final.pkl', 'rb'))
emotion_model = pickle.load(open('C:\\Users\\AKSHITA RAI\\OneDrive\\Desktop\\ML\\EndSem4 Project\\Real Time Age,Gender and Emotion detetction\\emotion-model-final.pkl', 'rb'))
